...
mongoose.connection.once('open', () => {
    console.log('conneted to MONGODB- st-kings database');
});
...
app.use('/', (req, res) => res.send("Welcome St-kings User"));
app.listen(process.env.PORT, () => console.log('St-kings Server is ready on localhost:' + process.env.PORT));
